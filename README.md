...
- [ ] BONUS - Create a single GET route to accomplish the tasks above, the result of the get route should be the output of the request in JSON format, while the inputs should be in the parameters of the request ex. GET somedomain/transactions?action=buy&date=01312021&brandId=brand3 (This should return the amount of credits bougth until 01/31/2022 for brand3)
